...
export const dealsConfig = {
    ...
    deals: [
        ...
        },
        {
            ...
            savingsAmount: 300,
            savingsPercent: 15,
            description: 'Full-frame powerhouse with phase detect AF. Incredible value for hybrids.',
        ...
        },
        {
            ...
            savingsAmount: 40,
            savingsPercent: 7,
            description: 'Creator Combo with wireless mic. Best portable vlog camera.',
    ...
    deDeals: [
        ...
        },
        {
            ...
            savingsAmount: 300,
            savingsPercent: 16,
            description: 'Vollformat-Kraftpaket mit Phasen-AF. Unglaubliches Preis-Leistungs-Verhältnis.',
            amazonUrl: 'https://amzn.to/45FQbyU',
            expiresAt: null,
            isHot: false,
            isLowest: true,
        ...
        },
        {
            ...
            savingsAmount: 40,
            savingsPercent: 8,
            description: 'Creator Combo mit kabellosen Mikrofon. Beste portable Vlog-Kamera.',
            amazonUrl: 'https://amzn.to/3PmNfHq',
            expiresAt: '2026-02-14',
            isHot: true,
            isLowest: false,
